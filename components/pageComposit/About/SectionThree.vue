<template>
  <section
    class="grid grid-cols-1 md:grid-cols-2 gap-6 items-center px-6 py-20 relative full-container overflow-x-clip">
    <div
      class="absolute w-[40rem] h-[40rem] opacity-50 top-1/2 left-full -translate-x-1/2 -translate-y-1/2 bg-radial-gradient blur-3xl">
    </div>
